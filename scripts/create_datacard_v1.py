def create_datacard_signal(data_int,his,dat_name='datacard'):
    ...
    f.write("rate \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f \t %.2f\n"%(his[0].Integral(),his[1].Integral(),his[2].Integral(),his[3].Integral(),his[4].Integral(),his[5].Integral(),his[6].Integral(),his[7].Integral(),his[8].Integral(),his[9].Integral(),his[10].Integral()))
    f.write("----------------------------------------------------------------------------\n") 
